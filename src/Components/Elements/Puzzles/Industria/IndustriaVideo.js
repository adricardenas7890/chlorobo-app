...
//     render() {
//         return (            
//             <ReactPlayer className="industria-player player-fade"
...
const IndustriaVideo = () => {

    return (
        <ReactPlayer className="industria-player player-fade" url="https://player.vimeo.com/video/530111521?title=0&amp;byline=0&amp;portrait=0&amp;speed=0&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479"
            height="100%"
            width="100%"
            controls={false}
            muted={true}
